 ...
 * @method static apiResult|mixed deleteAgent ( mixed $data=null ,string $queryString=null ) <p>request: DELETE node/agents/{agent}</p><p>template-var: agent => xs:string : template</p><p>query-String: deleteFiles => xs:boolean : query</p><p>query-String: gwiaSubDir => xs:string : query</p>
 ...
 * @method static apiResult|xsd\sslfiles generateAgentCert ( xsd\csrParams $data=null ,string $queryString=null ) <p>request: POST node/agents/{agent}/sslcerts</p><p>template-var: agent => xs:string : template</p>
 ...
 * @method static apiResult|mixed mountDatabase ( xsd\nodeDbInfo $data=null ,string $queryString=null ) <p>request: POST node/databases</p>
...
class node extends wadlProxy { 
	 ...
	 *
	 * <p>request: DELETE node/agents/{agent}</p>
	 ...
	 *
	 * <p>request: POST node/agents/{agent}/sslcerts</p>
	 * <p>template-var: agent => xs:string : template</p>
	 */
	...
	/**
	 * Add information about a new database that this node will manage. This  should be followed by a PUT to database/{id}/file to add the actual  file content for the database.
	 * @internal
	 *
	 * @param apiResult|xsd\nodeDbInfo $data user data; may repeat which will result in a merge
	 * @param string $queryString a whole query-string or one part like var=value; may repeat
	 * @return apiResult|mixed
	 *
	 * <p>request: POST node/databases</p>
	 */
	protected function _mountDatabase ($data=null,$queryString=null) { 
		return $this->doRequest ('mountDatabase',$data,$queryString);
	}
	/**
