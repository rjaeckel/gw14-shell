 ...
 * @method static apiResult|mixed setCertificate ( mixed $data=null ,string $queryString=null ) <p>request: PUT system/directories/{ldapserver}/certificate</p><p>template-var: directoryId => xs:string : template</p>
...
class system extends wadlProxy { 
	 ...
	 * @return apiResult|mixed
	 *
	 * <p>request: PUT system/directories/{ldapserver}/certificate</p>
